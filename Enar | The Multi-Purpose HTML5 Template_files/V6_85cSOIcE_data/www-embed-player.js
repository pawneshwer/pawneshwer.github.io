...
;var pd="StopIteration"in n?n.StopIteration:{message:"StopIteration",stack:""};function qd(){}
qd.prototype.next=function(){throw pd;};
qd.prototype.ca=function(){return this};
function rd(a){if(a instanceof qd)return a;if("function"==typeof a.ca)return a.ca(!1);if(ja(a)){var b=0,c=new qd;c.next=function(){for(;;){if(b>=a.length)throw pd;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function sd(a,b){if(ja(a))try{A(a,b,void 0)}catch(c){if(c!==pd)throw c;}else{a=rd(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==pd)throw c;}}}
function td(a){if(ja(a))return Aa(a);a=rd(a);var b=[];sd(a,function(a){b.push(a)});
return b}
;function P(){this.f=this.f;this.F=this.F}
P.prototype.f=!1;P.prototype.dispose=function(){this.f||(this.f=!0,this.o())};
function ud(a,b){a.f?p(void 0)?b.call(void 0):b():(a.F||(a.F=[]),a.F.push(p(void 0)?v(b,void 0):b))}
...
;function Q(a,b){this.b=0;this.w=void 0;this.i=this.f=this.g=null;this.j=this.l=!1;if(a!=t)try{var c=this;a.call(b,function(a){Hd(c,2,a)},function(a){Hd(c,3,a)})}catch(d){Hd(this,3,d)}}
...
var Jd=new bd(function(){return new Id},function(a){a.reset()},100);
function Kd(a,b,c){var d=Jd.get();d.g=a;d.f=b;d.context=c;return d}
function Ld(a){if(a instanceof Q)return a;var b=new Q(t);Hd(b,2,a);return b}
function Md(a){return new Q(function(b,c){c(a)})}
Q.prototype.then=function(a,b,c){return Nd(this,ka(a)?a:null,ka(b)?b:null,c)};
Gd(Q);Q.prototype.cancel=function(a){0==this.b&&jd(function(){var b=new Od(a);Pd(this,b)},this)};
function Pd(a,b){if(0==a.b)if(a.g){var c=a.g;if(c.f){for(var d=0,e=null,f=null,g=c.f;g&&(g.i||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Pd(c,b):(f?(d=f,d.next==c.i&&(c.i=d),d.next=d.next.next):Qd(c),Rd(c,e,3,b)))}a.g=null}else Hd(a,3,b)}
function Sd(a,b){a.f||2!=a.b&&3!=a.b||Td(a);a.i?a.i.next=b:a.f=b;a.i=b}
...
e.f=c?function(b){try{var e=c.call(d,b);!p(e)&&b instanceof Od?g(b):a(e)}catch(m){g(m)}}:g});
e.b.g=a;Sd(a,e);return e.b}
Q.prototype.C=function(a){this.b=0;Hd(this,2,a)};
Q.prototype.F=function(a){this.b=0;Hd(this,3,a)};
function Hd(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;a:{var d=c,e=a.C,f=a.F;if(d instanceof Q){Sd(d,Kd(e||t,f||null,a));var g=!0}else{if(d)try{var h=!!d.$goog_Thenable}catch(m){h=!1}else h=!1;if(h)d.then(e,f,a),g=!0;else{if(la(d))try{var k=d.then;if(ka(k)){Ud(d,k,e,f,a);g=!0;break a}}catch(m){f.call(a,m);g=!0;break a}g=!1}}}g||(a.w=c,a.b=b,a.g=null,Td(a),3!=b||c instanceof Od||Vd(a,c))}}
function Ud(a,b,c,d,e){function f(a){h||(h=!0,d.call(e,a))}
function g(a){h||(h=!0,c.call(e,a))}
var h=!1;try{b.call(a,g,f)}catch(k){f(k)}}
function Td(a){a.l||(a.l=!0,jd(a.B,a))}
function Qd(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.i=null);return b}
Q.prototype.B=function(){for(var a;a=Qd(this);)Rd(this,a,this.b,this.w);this.l=!1};
function Rd(a,b,c,d){if(3==c&&b.f&&!b.i)for(;a&&a.j;a=a.g)a.j=!1;if(b.b)b.b.g=null,Wd(b,c,d);else try{b.i?b.g.call(b.context):Wd(b,c,d)}catch(e){Xd.call(null,e)}cd(Jd,b)}
function Wd(a,b,c){2==b?a.g.call(a.context,c):a.f&&a.f.call(a.context,c)}
function Vd(a,b){a.j=!0;jd(function(){a.j&&Xd.call(null,b)})}
var Xd=dd;function Od(a){z.call(this,a)}
x(Od,z);Od.prototype.name="cancel";function R(a){P.call(this);this.l=1;this.i=[];this.j=0;this.b=[];this.g={};this.w=!!a}
...
function Yd(a,b,c,d){if(b=a.g[b]){var e=a.b;(b=ya(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.K(b)}}
...
l.V=function(a,b){var c=this.g[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.w)for(e=0;e<c.length;e++){var g=c[e];Zd(this.b[g+1],this.b[g+2],d)}else{this.j++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.b[g+1].apply(this.b[g+2],d)}finally{if(this.j--,0<this.i.length&&0==this.j)for(;g=this.i.pop();)this.K(g)}}return 0!=e}return!1};
function Zd(a,b,c){jd(function(){a.apply(b,c)})}
l.clear=function(a){if(a){var b=this.g[a];b&&(A(b,this.K,this),delete this.g[a])}else this.b.length=0,this.g={}};
l.o=function(){R.A.o.call(this);this.clear();this.i.length=0};function $d(a){this.b=a}
$d.prototype.set=function(a,b){p(b)?this.b.set(a,Ad(b)):this.b.remove(a)};
$d.prototype.get=function(a){try{var b=this.b.get(a)}catch(c){return}if(null!==b)try{return yd(b)}catch(c){throw"Storage: Invalid value was encountered";}};
$d.prototype.remove=function(a){this.b.remove(a)};function ae(a){this.b=a}
x(ae,$d);function be(a){this.data=a}
function ce(a){return!p(a)||a instanceof be?a:new be(a)}
ae.prototype.set=function(a,b){ae.A.set.call(this,a,ce(b))};
ae.prototype.f=function(a){a=ae.A.get.call(this,a);if(!p(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
ae.prototype.get=function(a){if(a=this.f(a)){if(a=a.data,!p(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function de(a){this.b=a}
x(de,ae);de.prototype.set=function(a,b,c){if(b=ce(b)){if(c){if(c<w()){de.prototype.remove.call(this,a);return}b.expiration=c}b.creation=w()}de.A.set.call(this,a,b)};
de.prototype.f=function(a,b){var c=de.A.f.call(this,a);if(c){var d;if(d=!b){d=c.creation;var e=c.expiration;d=!!e&&e<w()||!!d&&d>w()}if(d)de.prototype.remove.call(this,a);else return c}};function ee(a){this.b=a}
x(ee,de);function fe(){}
;function ge(){}
x(ge,fe);ge.prototype.clear=function(){var a=td(this.ca(!0)),b=this;A(a,function(a){b.remove(a)})};function he(a){this.b=a}
x(he,ge);l=he.prototype;l.isAvailable=function(){if(!this.b)return!1;try{return this.b.setItem("__sak","1"),this.b.removeItem("__sak"),!0}catch(a){return!1}};
...
l.ca=function(a){var b=0,c=this.b,d=new qd;d.next=function(){if(b>=c.length)throw pd;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!u(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
l.clear=function(){this.b.clear()};
l.key=function(a){return this.b.key(a)};function ie(){var a=null;try{a=window.localStorage||null}catch(b){}this.b=a}
x(ie,he);function je(){var a=null;try{a=window.sessionStorage||null}catch(b){}this.b=a}
x(je,he);var ke=window.performance&&window.performance.timing&&window.performance.now?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()},le="Microsoft Internet Explorer"==navigator.appName;
function me(a,b){if(1<b.length)a[b[0]]=b[1];else{var c=b[0],d;for(d in c)a[d]=c[d]}}
;var ne=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};q("yt.config_",ne,void 0);function S(a){me(ne,arguments)}
...
function se(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){V(b)}}:a}
;function W(a,b){ka(a)&&(a=se(a));return window.setTimeout(a,b)}
;var te=r("ytPubsubPubsubInstance")||new R;R.prototype.subscribe=R.prototype.subscribe;R.prototype.unsubscribeByKey=R.prototype.K;R.prototype.publish=R.prototype.V;R.prototype.clear=R.prototype.clear;q("ytPubsubPubsubInstance",te,void 0);var ue=r("ytPubsubPubsubSubscribedKeys")||{};q("ytPubsubPubsubSubscribedKeys",ue,void 0);var ve=r("ytPubsubPubsubTopicToKeys")||{};q("ytPubsubPubsubTopicToKeys",ve,void 0);var we=r("ytPubsubPubsubIsSynchronous")||{};q("ytPubsubPubsubIsSynchronous",we,void 0);
function xe(a,b){var c=ye();if(c){var d=c.subscribe(a,function(){var c=arguments;var f=function(){ue[d]&&b.apply(window,c)};
try{we[a]?f():W(f,0)}catch(g){V(g)}},void 0);
ue[d]=!0;ve[a]||(ve[a]=[]);ve[a].push(d);return d}return 0}
function ye(){return r("ytPubsubPubsubInstance")}
function ze(a){ve[a]&&(a=ve[a],A(a,function(a){ue[a]&&delete ue[a]}),a.length=0)}
...
function Ce(a){var b=ye();b&&("number"==typeof a?a=[a]:u(a)&&(a=[parseInt(a,10)]),A(a,function(a){b.unsubscribeByKey(a);delete ue[a]}))}
;var De=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Ee=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Fe(a,b){var c=Ge(a),d=document.getElementById(c),e=d&&qe(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=xe(c,b),g=""+(b[ma]||(b[ma]=++na));He[g]=e}f||(d=Ie(a,c,function(){qe(d,"loaded")||(re(d),Be(c),W(qa(Ae,c),0))}))}}
...
function Je(a,b){if(a&&b){var c=""+(b[ma]||(b[ma]=++na));(c=He[c])&&Ce(c)}}
function Ge(a){var b=document.createElement("a");Ib(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+va(a)}
var He={};function Ke(a,b){if(window.spf){var c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(De,""),c=c.replace(Ee,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else Fe(a,b)}
;var Le=null;function Me(){var a=T("BG_I",null),b=T("BG_IU",null),c=T("BG_P",void 0);b?Ke(b,function(){Ne(c)}):a&&(eval(a),Ne(c))}
function Ne(a){Le=new botguard.bg(a);U("botguard_periodic_refresh")?ke():U("botguard_always_refresh")}
...
function Ye(a,b){var c=T("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.qb&&(!Rb(J(a)[3]||null)||b.withCredentials||Rb(J(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.D&&b.D[c])}
function Ze(a,b){var c=b.format||"JSON";b.Ka&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=T("XSRF_FIELD_NAME",void 0),e=T("XSRF_TOKEN",void 0),f=b.kb;f&&(f[d]&&delete f[d],a=Ue(a,f||{}));var g=b.postBody||"",f=b.D;Ye(a,b)&&(f||(f={}),f[d]=e);f&&u(g)&&(d=Te(g),Ka(d,f),g=b.wa&&"JSON"==b.wa?JSON.stringify(d):Ve(d));var h=!1,k,m=$e(a,function(a){if(!h){h=!0;k&&window.clearTimeout(k);var d=Se(a),e=null;if(d||400<=a.status&&
500>a.status)e=af(c,a,b.pb);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||n;d?b.J&&b.J.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Qa&&b.Qa.call(f,a,e)}},b.method,g,b.headers,b.responseType,b.withCredentials);
b.O&&0<b.timeout&&(k=W(function(){h||(h=!0,m.abort(),window.clearTimeout(k),b.O.call(b.context||n,m))},b.timeout))}
function af(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=zd(a));break;case "XML":if(b=(b=b.responseXML)?bf(b):null)d={},A(b.getElementsByTagName("*"),function(a){d[a.tagName]=cf(a)})}c&&df(d);
return d}
...
function cf(a){var b="";A(a.childNodes,function(a){b+=a.nodeValue});
return b}
function ef(a,b){b.method="POST";b.D||(b.D={});Ze(a,b)}
function $e(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&se(b)(k)}
...
f}catch(G){k="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(mf[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){k=a.fileName;b={kb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},D:{url:T("PAGE_NAME",
window.location.href),file:k},method:"POST"};e&&(b.D.stack=e);for(var m in c)b.D["client."+m]=c[m];if(m=T("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var B in m)b.D[B]=m[B];Ze("/error_204",b);mf[a.message]=!0;lf++}}}
var mf={},lf=0;var nf=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};q("yt.msgs_",nf,void 0);function of(a){me(nf,arguments)}
...
g=se(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),a.addEventListener(b,g,d)):a.attachEvent("on"+b,g);Fa[e]=[a,b,c,g,d];return e}
function Bf(a){a&&("string"==typeof a&&(a=[a]),A(a,function(a){if(a in Fa){var b=Fa[a],d=b[0],e=b[1],f=b[3],b=b[4];d.removeEventListener?d.removeEventListener(e,f,b):d.detachEvent&&d.detachEvent("on"+e,f);delete Fa[a]}}))}
;function Cf(){if(null==r("_lact",window)){var a=parseInt(T("LACT"),10),a=isFinite(a)?w()-Math.max(a,0):-1;q("_lact",a,window);q("_fact",a,window);-1==a&&Df();Af(document,"keydown",Df);Af(document,"keyup",Df);Af(document,"mousedown",Df);Af(document,"mouseup",Df);xe("page-mouse",Df);xe("page-scroll",Df);xe("page-resize",Df)}}
function Df(){null==r("_lact",window)&&(Cf(),r("_lact",window));var a=w();q("_lact",a,window);-1==r("_fact",window)&&q("_fact",a,window);Be("USER_ACTIVE")}
function Ef(){var a=r("_lact",window);return null==a?-1:Math.max(w()-a,0)}
;function Ff(a,b,c,d){this.f=a;this.i=b;this.g=c;this.b=d}
...
function Pf(){window.clearTimeout(Lf);if(!Ga()){for(var a in C){var b=Jf[a];if(!b){var c=Kf[a];if(!c)continue;b=new c;Jf[a]=b}var c=void 0,d=a,e=If[d];for(c in C[d]){var f=b.f();f[e]=Of(d,c);f.requestTimeMs=Math.round(ke());var g=Mf[c];if(g)a:{var h=f,k=c;if(g.videoId)var m="VIDEO";else if(g.playlistId)m="PLAYLIST";else break a;h.credentialTransferTokenTargetId=g;h.context=h.context||{};h.context.user=h.context.user||{};h.context.user.credentialTransferTokens=[{token:k,scope:m}]}delete Mf[c];b.g(d,
f,{})}delete C[a]}Ga()||Qf()}}
...
;function Rf(a,b,c,d,e){var f={};f.eventTimeMs=Math.round(d||ke());f[a]=b;f.context={lastActivityMs:String(Ef())};Nf({endpoint:"log_event",va:f,da:e},c)}
...
function Tf(a,b,c){b.eventTimeMs=Math.round(ke());b.lactMs=Ef();c&&(b.clientData=Vf(c));Nf({endpoint:"log_interaction",va:b},a)}
...
var Yf,Zf=new ie;Yf=Zf.isAvailable()?new ee(Zf):null;var Xf,$f=new je;Xf=$f.isAvailable()?new ee($f):null;function ag(){var a=T("ROOT_VE_TYPE",void 0);return a?new Ff(void 0,a,void 0):null}
...
bg();d="ST-"+va(d).toString(36);e=b?Ve(b):"";uc.set(""+d,e,5,"/","youtube.com");b&&(b=b.itct||b.ved,d=r("yt.logging.screen.storeParentElement"),b&&d&&d(new Ff(b)))}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var h=void 0===h?{}:h;var k=void 0===k?"":k;var m=void 0===m?window:m;c=m.location;a=Sb(Ub([a],h))+k;a=a instanceof Ab?a:Eb(a);c.href=Cb(a)}return!0}
;var dg=r("yt.abuse.botguardInitialized")||Oe;q("yt.abuse.botguardInitialized",dg,void 0);var eg=r("yt.abuse.invokeBotguard")||Pe;q("yt.abuse.invokeBotguard",eg,void 0);var fg=r("yt.abuse.dclkstatus.checkDclkStatus")||tf;q("yt.abuse.dclkstatus.checkDclkStatus",fg,void 0);var gg=r("yt.player.exports.navigate")||cg;q("yt.player.exports.navigate",gg,void 0);var hg=r("yt.util.activity.init")||Cf;q("yt.util.activity.init",hg,void 0);var ig=r("yt.util.activity.getTimeSinceActive")||Ef;
q("yt.util.activity.getTimeSinceActive",ig,void 0);var jg=r("yt.util.activity.setTimestamp")||Df;q("yt.util.activity.setTimestamp",jg,void 0);function kg(a){a={client:{hl:a.Na,gl:a.Ma,clientName:a.La,clientVersion:a.innertubeContextClientVersion}};T("DELEGATED_SESSION_ID")&&(a.user={onBehalfOfUser:T("DELEGATED_SESSION_ID")});return a}
...
function pg(a){return(new Q(function(b){try{var c={gapiHintOverride:a.gapiHintOverride,_c:{jsl:{h:a.gapiHintParams}},callback:b},d=ka(c)?{callback:c}:c||{};d._c&&d._c.jsl&&d._c.jsl.h||Ka(d,{_c:{jsl:{h:T("GAPI_HINT_PARAMS",void 0)}}});if(d.gapiHintOverride||T("GAPI_HINT_OVERRIDE")){var e=document.location.href;if(-1!=e.indexOf("?")){var e=(e||"").split("#")[0],f=e.split("?",2);var g=Te(1<f.length?f[1]:f[0])}else g={};var h=g.gapi_jsh;h&&Ka(d,{_c:{jsl:{h:h}}})}$c("client",d)}catch(k){V(k)}})).then(function(){})}
...
function qg(a,b,c,d){var e={path:mg(a.b.innertubeApiVersion,b,c),headers:{"X-Goog-Visitor-Id":T("VISITOR_DATA")},method:"POST",body:Ad(c)},f=v(a.i,a);og.then(function(){f();r("gapi.client.request")(e).execute(d||t)})}
...
timeout:c.timeout,withCredentials:!0},e=vc();e&&(d.headers.Authorization=e,d.headers["X-Goog-AuthUser"]=T("SESSION_INDEX",0));var f=this.b.xhrApiaryHost;f.startsWith("http")||(f="//"+f);if(U("youtubei_for_web")||U("unplugged_web_same_op_domain"))f="";var g=this.b.Oa;g&&(f=g);e&&!f&&(d.headers["x-origin"]=window.location.origin);ef(""+f+mg(this.b.innertubeApiVersion,a,b)+"?alt=json&key="+this.b.innertubeApiKey,d)};function sg(){return U("enable_youtubei_innertube")?rg:ng}
...
10)||0;a=[c,d,e]}else a=[0,0,0];this.i=b;b=a;this.b=b[0];this.f=b[1];this.g=b[2];if(0>=this.b){if(le)try{var g=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(B){g=null}else{var h=document.body;var k=document.createElement("object");k.setAttribute("type","application/x-shockwave-flash");g=h.appendChild(k)}if(g&&"GetVariable"in g)try{var m=g.GetVariable("$version")}catch(B){m=""}h&&k&&h.removeChild(k);(g=m||"")?(g=g.split(" ")[1].split(","),g=[parseInt(g[0],10)||0,parseInt(g[1],10)||0,parseInt(g[2],
...
function Dg(a){var b=Eg(a),c=document.getElementById(b),d=c&&qe(c,"loaded");d||c&&!d||(c=Fg(a,b,function(){qe(c,"loaded")||(re(c),Be(b),W(qa(Ae,b),0))}))}
...
x(Vg,P);function Wg(a,b,c,d){d=se(v(d,a.g));d={target:b,name:c,ra:d};b.addEventListener(c,d.ra,void 0);a.b.push(d)}
function Xg(a){for(;a.b.length;){var b=a.b.pop();b.target.removeEventListener(b.name,b.ra)}}
Vg.prototype.o=function(){Xg(this);Vg.A.o.call(this)};var Yg=r("ytLoggingLatencyUsageStats_")||{};q("ytLoggingLatencyUsageStats_",Yg,void 0);var Zg=0;function $g(a){Yg[a]=Yg[a]||{count:0};var b=Yg[a];b.count++;b.time=ke();Zg||(Zg=pf(ah,0));return 10<b.count?(11==b.count&&kf(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
function ah(){var a=ke(),b;for(b in Yg)6E4<a-Yg[b].time&&delete Yg[b];Zg=0}
...
delete b.h5jse}a.aft=th();Bh()&&"youtube"==g&&(vh(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=ke();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=r("ytdebug.logTiming"))&&a(f,b);xh(f,e,void 0);hh(new jh(b.aft+(h||0),void 0))}}}
...
;function Ch(a,b){P.call(this);this.w=this.l=a;this.T=b;this.C=!1;this.g={};this.Z=this.S=null;this.U=new R;ud(this,qa(vd,this.U));this.j={};this.L=this.aa=this.i=this.ha=this.b=null;this.W=!1;this.M=this.B=this.H=this.R=null;this.ba={};this.Ca=["onReady"];this.X=new Vg(this);ud(this,qa(vd,this.X));this.fa=null;this.oa=NaN;this.Y={};Dh(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Ea,this));this.G("onTabAnnounce",v(this.pa,this));this.G("WATCH_LATER_VIDEO_ADDED",
v(this.Ua,this));this.G("WATCH_LATER_VIDEO_REMOVED",v(this.Va,this));rb||(this.G("onMouseWheelCapture",v(this.Ra,this)),this.G("onMouseWheelRelease",v(this.Sa,this)));this.G("onAdAnnounce",v(this.pa,this));this.N=new Vg(this);ud(this,qa(vd,this.N));this.ga=!1;this.ea=null}
...
function Kh(a,b){if((!b||(5!=(Gg[b.errorCode]||5)?0:-1!=Eh.indexOf(b.errorCode)))&&Jh(a)){var c=Lh(a);c&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=xg(c));d.args.autoplay=1;d.args.html5_unavailable="1";Fh(a,d);Gh(a,"flash")}}
...
function Mh(a){var b=!0,c=Lh(a);c&&a.b&&(a=a.b,b=qe(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
...
this.W=!0;a?this.R():(Ke(this.b.assets.js,this.R),Cg(this.b.assets.css),Ph(this)&&!b&&q("yt.player.Application.create",null,void 0))}}};
...
l.bb=function(a,b){if(!this.f){var c=Ih(this,b);c&&Yd(this.U,a,c)}};
...
l.pa=function(a){Be("a11y-announce",a)};
l.Ta=function(a){Kh(this,a)};
l.Ua=function(a){Be("WATCH_LATER_VIDEO_ADDED",a)};
l.Va=function(a){Be("WATCH_LATER_VIDEO_REMOVED",a)};
...
l.cancel=function(){this.R&&Je(this.b.assets.js,this.R);window.clearTimeout(this.oa);this.W=!1};
...
;var Sh={},Th="player_uid_"+(1E9*Math.random()>>>0);function Uh(a){var b="player",b=u(b)?Jb(b):b;a=xg(a);var c=Th+"_"+(b[ma]||(b[ma]=++na)),d=Sh[c];if(d)return d.na(a),d.g;d=new Ch(b,c);Sh[c]=d;Be("player-added",d.g);ud(d,qa(Vh,d));W(function(){d.na(a)},0);
return d.g}
...
l.o=function(){var a=this.g;a.f||Yd(a.b,"command",this.xa,this);this.g=null;for(var b in this.i)ci(this,b);ai.A.o.call(this)};function fi(a,b){ai.call(this,b);this.b=a;this.start()}
...
b.args))}}};
gi.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Ad(a);c.postMessage(d,this.B)}catch(e){V(e,"WARNING")}}};
...
l.dispose=function(){li.A.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function mi(){P.call(this);this.b=new R;ud(this,qa(vd,this.b))}
...
x(ni,mi);function bi(a,b,c){if(!a.f){var d=a.g;d.f||a.i!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(Ad(a),d.i))}}
ni.prototype.o=function(){this.i=this.g=null;ni.A.o.call(this)};function oi(a,b,c){P.call(this);this.b=a;this.i=c;this.j=Af(window,"message",v(this.l,this));this.g=new ni(this,a,b);ud(this,qa(vd,this.g))}
...
oi.prototype.o=function(){Bf(this.j);this.b=null;oi.A.o.call(this)};function pi(){var a=Ia(qi);return new Q(function(b,c){a.J=function(a){Se(a)?b(a):c(new ri("Request failed, status="+a.status,"net.badstatus"))};
...
aa(ri,z);function si(a){z.call(this,a.message||a.description||a.name);this.Pa=a instanceof ti;this.b=a instanceof Od}
...
ui.prototype.then=function(a,b,c){try{if(p(this.f))return a?Ld(a.call(c,this.f)):Ld(this.f);if(p(this.b)){if(!b)return Md(this.b);var d=b.call(c,this.b);return!p(d)&&this.b.b?Md(this.b):Ld(d)}throw Error("Invalid Result_ state");}catch(e){return Md(e)}};
Gd(ui);var qi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},vi=null;function wi(){if(!vi){var a=v(xi,n,2),b=pi().then(yi);vi=Nd(b,null,a,void 0)}return vi}
...
function Ai(a,b){W(function(){var a=v(xi,n,b),a=pi().then(yi,a);Nd(a,null,t,void 0)},a)}
function zi(a){q("yt.ads.biscotti.lastId_",a,void 0)}
;function Bi(a){a.Pa&&Ci("")}
function Di(a){!a||r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_")||q("yt.ads.biscotti.getId_",wi,void 0);try{try{var b=r("yt.ads.biscotti.getId_")||r("yt.www.ads.biscotti.getId_");var c=b?b():wi()}catch(d){c=Md(d)}c.then(Ci,Bi);W(Di,18E5)}catch(d){V(d)}}
var Ei=0;
...
for(var ta in N)b[ta]=N[ta]}b.bsq=Ei++;ef("//www.youtube.com/ad_data_204",{Ka:!1,D:b})}
...
Ni);a.addEventListener("onLogVeClicked",Ri);a.addEventListener("onLogVesShown",Si);a.addEventListener("onReady",Ti);b=T("POST_MESSAGE_ID","player");T("ENABLE_JS_API")?Li=new li(a):T("ENABLE_POST_API")&&u(b)&&u(c)&&(Ki=new oi(window.parent,b,c),Li=new fi(a,Ki.g));T("BG_P")&&(T("BG_I")||T("BG_IU"))&&Me();sf()},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){hf(a+"mac_204?action_fcts=1");return!0},void 0);
var Ui=se(function(){ph("ol");var a=Fi.getInstance(),b=1<window.devicePixelRatio;if(!!((Ii("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Ii(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in Z)b.push(e+"="+escape(Z[e]));uc.set(""+a,b.join("&"),63072E3,"/","youtube.com")}}),Vi=se(function(){var a=Ji;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();T("PL_ATT")&&(Le=null);for(var a=0,b=qf.length;a<b;a++){var c=qf[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):window.clearTimeout(c)}}qf.length=0;a=Ge("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))Ae(a),b.parentNode.removeChild(b);rf=!1;S("DCLKSTAT",0);wd(Li,Ki);if(a=Ji)a.removeEventListener("onScreenChanged",Pi),a.removeEventListener("onLogClientVeCreated",Oi),a.removeEventListener("onLogServerVeCreated",
